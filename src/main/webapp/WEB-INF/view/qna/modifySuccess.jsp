...
<div class="container" style="text-align: center">
    ...
    <div style="margin: 30px 100px 30px 100px;">
        ...
        <hr>
        <h4 style="margin-top: 50px; text-align: center;">게시글을 수정했습니다.</h4>
<br>
${ctxPath = pageContext.request.contextPath ; ''}
        <div class="find-btn">
            <button class="send" style="background-color: #ff914d;" onclick="location.href='${ctxPath}/qna/list'"  >목록 보기</button>
            <button class="send" style="background-color: #ff914d;" onclick="location.href='${ctxPath}/qna/read?no=${modReq.QNum}'"  >내용 확인</button>
        </div>
    </div>
</div>
</body>
