...
<div class = "container" style="text-align: center; margin-top: 150px;">
	<h3 style="margin: 50px;">찾으시는 정보를 선택하세요.</h3>
	<a href = "/findId" style="text-decoration: none; color: black;">[아이디 찾기] | </a>
	<a href = "/findPassword"  style="text-decoration: none; color: black;">[비밀번호 찾기]</a>
	</div>
</body>
</html>