...
<h3><strong>${authUser.userName}님</strong>, 안녕히 가세요.</h3>

<a href="${pageContext.request.contextPath}/main"><button style=" border-radius: 20px; margin-top: 80px;">메인으로 돌아가기</button></a>
</div>
<div class="container" style="display: flex; margin: 0 auto;">
<img src = "${pageContext.request.contextPath}/img/ad1.png" style="margin-right:750px; width: 250px; height: auto;">
<img src = "${pageContext.request.contextPath}/img/ad2.png" style="width: 250px; height: auto;">
</div>
</body>
</html>